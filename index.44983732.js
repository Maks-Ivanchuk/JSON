        ...
        buttonsUsers.forEach((buttonUser)=>{
            buttonUser.addEventListener("click", function(event) {
                ...
                if (target.classList.contains("btn-todos")) {
                    if (!document.querySelector("#result1")) tableWrapper.insertAdjacentHTML("beforeend", `
                     <table id = "result1">
                        <tr>
                ...
                if (target.classList.contains("btn-posts")) {
                  ...
                  `);
                    ...
                    let tableResult1 = document.querySelector("#result1");
                    fetch(`https://jsonplaceholder.typicode.com/users/${userId}/posts`).then((response)=>response.json()).then((posts)=>{
                     ...
                     `);
                        ...
                        btnsComments.forEach((btnComment)=>{
                            btnComment.addEventListener("click", function(event) {
                                if (!document.querySelector("#result2")) tableWrapper.insertAdjacentHTML("beforeend", `
                              <table id = "result2">
                                 <tr>
